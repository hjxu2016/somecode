...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 10:18:43 2017
...
heatmap_feature_names = ['name','region_count', 'ratio_tumor_tissue', 'largest_tumor_area', 'longest_axis_largest_tumor',
...
def extract_features(img_name,heatmap_prob, image_open):
    """
        Feature list:
...
f_test = '/home/hjxu/breast_project/Extract_Features_heatmap/feature_test.csv'
