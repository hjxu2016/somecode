...
PATCH_SIZE = 256
NUM_NEGATIVE_PATCHES_FROM_EACH_BBOX = 250
NUM_POSITIVE_PATCHES_FROM_EACH_BBOX = 500
TUMOR_WSI_PATH = '/media/hjxu/Elements/Camelyon16/Training/Normal'
#TUMOR_MASK_PATH = '/media/hjxu/Elements/Camelyon16/Testset/Ground_Truth/Masks'
PATCHES_TRAIN_POSITIVE_PATH = '/home/hjxu_disk/label-1/normal-1'
