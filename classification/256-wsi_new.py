...
WSI = '/media/hjxu/Elements/Camelyon16/Training/N/Normal_099.tif'
...
plt.show()
scipy.misc.imsave('/home/hjxu/breast_project/reports/Normal_099_p.tif', image_heat_save)
end = time.time()
